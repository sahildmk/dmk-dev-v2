  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6 ">
      <div className="hover:scale-[103%] transition-all duration-300">
        <section className="animate-slide-in bg-neutral-900/30 rounded-lg sm:rounded-xl w-full sm:w-[500px] p-5 sm:p-8 dark:text-neutral-400 backdrop-blur-xl border dark:border-neutral-600/40 transition-all">
